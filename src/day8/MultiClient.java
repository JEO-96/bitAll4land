...
public class MultiClient implements ActionListener {
	...
	private JPanel jp1, jp2, jp3, jp4, jp5; // South, North, South(버튼), Center, jp4.North
	private String ip; // ip 주소
	private String id; // 사용자 id
	private JButton inputBtn, emoticonBtn, clearBtn, userListBtn, noticeResigtrationBtn; // 입력, 이모티콘, 공지등록, 초기화, 유저목록,
	...
	public MultiClient(String argIp, String argId) {
		...
		jp2.add(userListBtn, BorderLayout.EAST);
